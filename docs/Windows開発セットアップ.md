...
VOICEVOX を入れるまでは、Windows 内蔵の日本語音声（Haruka など）で代用する。
内蔵の日本語音声が無い環境（日本語言語パック未導入など）では、吹き出しの文字だけになる。
...
| 声が出ない | VOICEVOX 未インストールかつ内蔵の日本語音声も無い（VOICEVOX を入れるか、日本語の音声パックを追加する） |
