...
async function generateIdleLines() {
  ...
  idleLineGeneration = (async () => {
    ...
    const prompt = [
      ...
      "短い通常セリフは、隣の席の相棒がふと漏らす一言にしてください。作業の手は止めさせず、軽い独り言・小さな気づき・ちょっとした感心やボケが向いています。",
      "通常セリフの中身は、目の前の作業への素朴な感想、ものづくりのあるある、ふと浮かんだ小ネタ、コーヒーや音楽など身の回りの話、軽い自慢や照れ隠しなど。1個ごとに話題を変えてください。",
      ...
      latestTopicText
        ...
        : "",
      "次は必ず避けてください: 『保存しました？』のような確認やお小言の繰り返し、『◯時台ですね』のような時刻の実況、ユーザーの様子を見張る発言、説教。",
